...
`brew install ack autoconf bash bash-completion fasd fish git jq libevent mercurial mysql node openssl phantomjs pkg-config rbenv readline rmtrash ruby-build the_platinum_searcher tmux vim`
`brew doctor`
`brew update`
